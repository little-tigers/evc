...
import cn.v1.evc.cec.data.ResChargeDetails;
 ...
 * Created by wr
 * on 2018/11/23
 * @Description: 推送订单状态，区别ResChargeStatus 防止数据污染
 */
public class PushChargeStatus implements Serializable{

    private static final long serialVersionUID = -8840109542479667401L;
    ...
    private List<PushChargeDetails> chargeDetails; //充电明细
